...
export MNE_INSTALLER_JSON_NAME="${MNE_INSTALLER_NAME}.env.json"
...
echo "Installer JSON: ${MNE_INSTALLER_JSON_NAME}"
test "$MNE_INSTALLER_JSON_NAME" != ""
...
if [[ "$GITHUB_ACTIONS" == "true" ]]; then
    ...
    echo "MNE_INSTALLER_JSON_NAME=${MNE_INSTALLER_JSON_NAME}" | tee -a $GITHUB_ENV
